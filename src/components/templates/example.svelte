...
<script>
    // ALL THE VARIABLES HERE ARE NEEDED BY THE TEMPLATE AND CAN'T BE OMITTED
...
>
    <div class="cardSide cardSide--front">
        ...
        <p style="font-size: 4rem; margin: 1.2rem 0 0;">Hover to flip</p>
    </div>
    <div class="cardSide cardSide--back">
        ...
        <div class="bottomPart">
            ...
            {#if values.logo.base64}
                <img class="bottomPart__image" src={values.logo.base64} alt="logo">
            {/if}
        </div>
    </div>
</div>
